...
const sizeConfig = {
    sm: {
        container: 'h-[240px] w-[240px] md:h-[300px] md:w-[300px]',
        fontSize: 'text-[10px] md:text-xs',
        tracking: 'tracking-[0.2em] md:tracking-[0.25em]',
        radius: 100, // Reduced for mobile
        gap: 20,
        imageSize: 'w-[70%] h-[70%]',
        textStyle: 'font-semibold'
    },
    md: {
        container: 'h-[320px] w-[320px] md:h-[400px] md:w-[400px]',
        fontSize: 'text-xs md:text-sm',
        tracking: 'tracking-[0.25em] md:tracking-[0.3em]',
        radius: 130, // Reduced for mobile
        gap: 15,
        imageSize: 'w-[70%] h-[70%]',
        textStyle: 'font-semibold',
    },
    lg: {
        container: 'h-[380px] w-[380px] md:h-[500px] md:w-[500px]',
        fontSize: 'text-xs md:text-base',
        tracking: 'tracking-[0.3em] md:tracking-[0.35em]',
        radius: 150, // Reduced for mobile
        gap: 10,
        imageSize: 'w-[70%] h-[70%]',
        textStyle: 'font-semibold'
    }
                    ...
                    <svg viewBox="0 0 400 400" className="w-full h-full">
                        <defs>
                            ...
                            <filter id="textShadow" x="-20%" y="-20%" width="140%" height="140%">
                                <feDropShadow dx="0" dy="1" stdDeviation="1" floodColor="#ffffff" floodOpacity="0.6" />
                            </filter>
                        </defs>
                        <path
                            id="curve"
